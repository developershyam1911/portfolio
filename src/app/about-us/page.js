...
export async function generateMetadata() {
  return {
    ...
    description:
      "Learn more about Shyam Mishra, a skilled software engineer specializing in web development, software solutions, and more. Discover his journey, skills, and passion for technology.",
    keywords: [
