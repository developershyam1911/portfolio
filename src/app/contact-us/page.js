...
export async function generateMetadata() {
  return {
    ...
    openGraph: {
      title: "Contact Shyam Mishra - Get in Touch | DevShyamTech",
      description:
        "Contact Shyam Mishra for inquiries, collaborations, or to discuss your software engineering needs. Get in touch with a skilled professional passionate about web development and software solutions.",
