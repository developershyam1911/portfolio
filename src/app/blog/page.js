...
export async function generateMetadata() {
  return {
    ...
    description: 'Explore the latest tech insights, updates, and industry trends with Shyam Mishra, a seasoned software engineer passionate about web development, software solutions, and more.',
    keywords:[
      'Tech Insights',
      'updates',
      'Shyam Mishra\'s Blog',
