                    ...
                    <div className="row justify-content-between align-items-center mb-n5">
                        <div className="col-auto mb-5">
                            <div className="footer-single-info">
                                <a href={`tel:${process.env.NEXT_PUBLIC_PHONE_NO}`} className="info-box">
                                    <span className="icon"><MdPhone size={22}/></span>
                                    <span className="text">{process.env.NEXT_PUBLIC_PHONE_NO}</span>
                                </a>
                            </div>
                        </div>
                        <div className="col-auto mb-5">
                            <div className="footer-single-info">
                                <a href={`mailto:${process.env.NEXT_PUBLIC_EMAIL_ID}`} className="info-box">
                                    <span className="icon"><MdEmail size={22}/></span>
                                    <span className="text">{process.env.NEXT_PUBLIC_EMAIL_ID}</span>
                                </a>
                            </div>
                    ...
                    <div className="row justify-content-center justify-content-md-between align-items-center flex-column-reverse flex-md-row">
                        <div className="col-auto">
                            <div className="footer-copyright">
                                <p className="copyright-text">&copy; 2024 <a href="/">devshyamtech</a> Made with <FaHeart size={22} color="white" /> by <a href="https://devshyamtech.in/" target="_blank">Shyam</a> </p>
                            </div>
                        </div>
                        <div className="col-auto">
