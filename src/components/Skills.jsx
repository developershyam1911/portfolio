                    ...
                    <div className="row align-items-center">
                        <div className="col-xl-6 col-xxl-5">
                            <div className="section-content">
                                ...
                                <a href="#" className="btn btn-xl btn-outline-one icon-space-left">Get Resume <MdDownload size={22}/></a>
                            </div>
                        </div>
                            ...
                            <div className="skill-display-wrapper">
                                {
                                    data?.map((item, i)=>{
                                        return(
                                            ...
                                            <ProgressBar striped variant="primary" now={item.persent} label={`${item.persent}%`} />
                                        </div>
                                        )
                                    })
                                }
