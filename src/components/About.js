              ...
              <div className="row align-items-center">
                <div className="col-xl-5 col-lg-6 col-md-6 col-sm-8 col-10 offset-1 offset-sm-2 offset-md-3 offset-lg-0">
                  <div className="video-card">
                    <a
                      className="wave-btn"
                      href="https://www.youtube.com/@devshyamtech"
                      data-autoplay="true"
                      data-vbtype="video"
                    >
                ...
                <div className="col-xl-6 col-lg-6 col-md-8 offset-md-2 offset-lg-0 offset-xl-1">
                  <div className="video-info-content">
                    <h2 className="title">
                      I’m {process.env.NEXT_PUBLIC_NAME}
                    </h2>

                    <h3 className="sub-title">Full Stack Developer</h3>
                    <p style={{ textAlign: "justify" }}>
                      Expert in creating dynamic and robust web applications
                      using the MERN stack (MongoDB, Express, React, Node.js).
                      Skilled in Laravel, React Native, and Next.js for
                          ...
                          <div className="content">
                            ...
                            <div className="right">
                              ...
                              <span className="institute-name">
                                Mahatma Jyotiba Phule Govt. Polytechnic,
                                Kaushambi
                              </span>
                              <p style={{ textAlign: "justify" }}>
                                Completed a diploma in Computer Science from
                                Mahatma Jyotiba Phule Govt. Polytechnic,
                                Kaushambi (2020-2023). Developed a strong
                          ...
                          <div className="content">
                            ...
                            <div className="right">
                              ...
                              <p style={{ textAlign: "justify" }}>
                                ...
                                at Dr. Rizvi College of Engineering, Kaushambi,
                                and in my second year. This program is enhancing
                                my knowledge in advanced computing concepts,
                                software engineering principles, and emerging
                                technologies.{" "}
                              </p>
                            </div>
                          </div>
                        ...
                        <li className="resume-tab-list-single-item">
                          <div className="content">
                            ...
                            <div className="right">
                              ...
                              <p style={{ textAlign: "justify" }}>
                                During my six-month internship at Event Planet
                                Technologies India Pvt Ltd in Lucknow, I gained
                                practical experience and enhanced my skills in
                                various web development technologies. I worked
                                extensively with React.js for building dynamic
                                user interfaces, Node.js and Express.js for
                                developing server-side applications, Next.js for
                                server-side rendering and static site
                                generation, and MongoDB for managing databases.
                                This hands-on experience helped me understand
                                the full stack development process and apply my
                        ...
                        <li className="resume-tab-list-single-item">
                          <div className="content">
                            ...
                            <div className="right">
                              ...
                              <p style={{ textAlign: "justify" }}>
                                I am currently working at Event Planet
                                Technologies India Pvt Ltd in Lucknow, where I
                                have been employed for the past year. In this
                                role, I am primarily focused on the MERN stack,
                                which includes MongoDB, Express.js, React.js,
                                and Node.js. My responsibilities involve
                                developing and maintaining web applications,
                                creating dynamic user interfaces, building
                                RESTful APIs, and managing databases. This
                                position has allowed me to deepen my expertise
                                in full stack development and contribute to
                                various innovative projects within the company.
                              </p>
                            </div>
                          </div>
                        </li>
